...
UserSchema.methods.validatePassword = function (password) {
  let _password = crypto.pbkdfSync(password, env.salt, 10000, 32, 'sha512').toString('hex');
  return this.password === _password 
}
UserSchema.methods.setPassword = function (password) {
  let _password = crypto.pbkdf2Sync(password, env.salt, 10000, 32, 'sha512').toSring('hex');
}
